...
const features = [
  {
    ...
    description:
      "Track your parcel in real time from pick-up to delivery using our smart tracking system.",
  },
  {
    icon: img2,
    title: "Safe & Secure Delivery",
    description:
      "We ensure your packages are handled with the highest safety standards and insured delivery.",
  },
  {
    icon: img3,
    title: "24/7 Call Center Support",
    description:
      "Our dedicated support team is available any time to answer your questions and resolve issues quickly.",
  },
];
